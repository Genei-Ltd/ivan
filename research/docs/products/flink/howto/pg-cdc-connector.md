...
1.  In the **Add new source table** screen, select the _Aiven for
    PostgreSQL®_ service as the integrated service.
...
1.  Select **Next** to add the sink table, and select **Add your
    first sink table**. Select _Aiven for Apache Kafka®_ as the
...
1.  Select **Create deployment** to deploy the application, and in the
