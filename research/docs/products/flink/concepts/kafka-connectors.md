...
In addition to integration with Apache Kafka® through a standard connector, Aiven for Apache Flink® also supports the use of _upsert_ connectors, which allows you to create changelog-type data streams.
