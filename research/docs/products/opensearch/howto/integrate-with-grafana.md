...
1.  Use your preferred in the _Name_ field. You'll use it later for
    creating dashboards and alerts.
1.  Set _URL_ to `OPENSEARCH_URI`.
1.  In _Auth_ section enable **Basic auth** and **With Credentials**.
1.  In _Basic Auth Details_ set your `OPENSEARCH_USER` and
    `OPENSEARCH_PASSWORD`.
1.  Scroll down to _OpenSearch details_ and set the index name or an
