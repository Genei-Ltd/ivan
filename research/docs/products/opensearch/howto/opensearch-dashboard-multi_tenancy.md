...
default tenants: _Global_ and _Private_, which are available even
...
- **Switch between tenants**: Besides creating new tenants, you can
  ...
  selected tenant**.
- **View and create Index Patterns**: To view and create _Index
  Patterns_, _Saved Objects_, and manage _Advanced settings_, select
