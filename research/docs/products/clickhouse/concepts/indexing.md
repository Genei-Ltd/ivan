...
index type is descriptively called _sparse index_, and the batch of rows
is sometimes called _granule_.
...
:::note[Example]
You have numeric column _number of page visits_ and run a query to
