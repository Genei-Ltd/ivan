...
You can integrate Aiven for ClickHouse® with either _Aiven for PostgreSQL_ service located in the same project, or _an external PostgreSQL endpoint_.
...
1.  Get _the service integration id_ by requesting the full list of
